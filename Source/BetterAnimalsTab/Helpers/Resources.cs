...
namespace BetterAnimalsTab
{
	...
	public static class Resources
	{
		...
		public static readonly Texture2D HuntTex = ContentFinder<Texture2D>.Get("UI/Buttons/hunt");

		public static readonly Texture2D TameTex = ContentFinder<Texture2D>.Get("UI/Buttons/tame");

		public static readonly Texture2D IntelTex = ContentFinder<Texture2D>.Get("UI/Buttons/brain");

		public static readonly Texture2D[] TrainableIntelligenceTextures =
		{
			ContentFinder<Texture2D>.Get( "UI/TrainableInteligence/none" ),
			ContentFinder<Texture2D>.Get( "UI/TrainableInteligence/simple" ),
			ContentFinder<Texture2D>.Get( "UI/TrainableInteligence/intermediate" ),
			ContentFinder<Texture2D>.Get( "UI/TrainableInteligence/advanced" ),
			ContentFinder<Texture2D>.Get( "UI/TrainableInteligence/unknown" ),
			ContentFinder<Texture2D>.Get( "UI/TrainableInteligence/unknown" )
		};
